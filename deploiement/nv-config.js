...
window.NV_CONFIG = {
  ...
  storage: {
    ...
    /* Plus aucun jeton d'envoi ici. Ce fichier est servi à tous les visiteurs :
       un secret placé là était publiquement lisible, donc n'en était pas un.
       L'autorisation d'envoi repose désormais sur la session de l'administrateur
       connecté, vérifiée par le worker auprès de Supabase (REQUIRE_AUTH=true).
       Le jeton expire, il est révocable, et il n'apparaît nulle part dans le code. */
